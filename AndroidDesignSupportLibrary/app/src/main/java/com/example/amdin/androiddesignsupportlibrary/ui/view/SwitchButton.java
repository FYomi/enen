package com.example.amdin.androiddesignsupportlibrary.ui.view;
 ...
 *
 * @Override public void onCheckedChanged(SwitchButton s, boolean isChecked) {
 * if (isChecked) {
 * Toast.makeText(getActivity(), "日间模式", Toast.LENGTH_SHORT).show();
 * view.setBackgroundResource(R.color.defaultSwitchOnColor);
 * } else {
...
public class SwitchButton extends View implements Checkable {
    ...
    private static final int DEFAULT_WIDTH = 100;      //按钮的宽
    private static final int DEFAULT_HEIGHT = DEFAULT_WIDTH / 2;//按钮的高
    private static final int DEFAULT_SPOT_PADDING = 6;
    private static final int DEFAULT_BORDER_WIDTH = 4;

    private static final int DEFAULT_SWITCH_ON_COLOR = 0xFF9EE3FB;//白天模式的填充色
    private static final int DEFAULT_SWITCH_ON_COLOR_OUT = 0xFF86C3D7;//白天模式的边框色
    private static final int DEFAULT_SWITCH_OFF_COLOR = 0xFF3C4145;//夜间模式的填充色
    private static final int DEFAULT_SWITCH_OFF_COLOR_OUT = 0xFF1C1C1C;//夜间模式的边框色

    private static final int DEFAULT_SPOT_ON_COLOR = 0xFFE1C348;//太阳的边框
    private static final int DEFAULT_SPOT_ON_COLOR_IN = 0xFFFFDF6D;//太阳的填充
    private static final int DEFAULT_SPOT_OFF_COLOR = 0xFFE3E7C7;//月亮的边框
    private static final int DEFAULT_SPOT_OFF_COLOR_IN = 0xFFFFFFFF;//月亮的填充
    ...
    private int duration;//期间

    private OnCheckedChangeListener onCheckedChangeListener;//监听的接口
     ...
     * @param checked
     */
    public void setInitialState(boolean checked) {
        if (isMoving) {
            return;
        }
